const toneByStatus: Record<string, string> = {
  ...
  duplicate_upload: 'border-rose-200 bg-rose-50 text-rose-700',
  parse_error: 'border-amber-200 bg-amber-50 text-amber-700',
  invalid_multi_session: 'border-rose-200 bg-rose-50 text-rose-700',
  session_mismatch: 'border-orange-200 bg-orange-50 text-orange-700',
};
